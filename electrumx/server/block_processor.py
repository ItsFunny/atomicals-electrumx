...
import electrumx
from electrumx.server.adapter import add_ft_in_trace, add_ft_transfer_out_trace, merge_trace, ACTIVE_HEIGHT
...
class BlockProcessor:
    ...
    def advance_txs(
            ...
            for txin in tx.inputs:
                ...
                if self.is_atomicals_activated(height):
                    ...
                    if len(atomicals_transferred_list):
                        ...
                        add_ft_in_trace(self.ft_transfer_trace_in_cache,tx_hash, txin.prev_hash, txin_index, atomicals_transferred_list)
        ...
        if self.is_atomicals_activated(height):
            merge_trace(self.ft_transfer_trace_in_cache,self.ft_transfer_trace_out_cache,self.general_data_cache,height)
